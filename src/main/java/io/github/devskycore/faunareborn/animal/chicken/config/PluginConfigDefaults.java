...
public final class PluginConfigDefaults {
    ...
    public static final boolean ITEM_PICKUP_TERRITORIALITY_ENABLED = true;
    public static final int ITEM_PICKUP_EGG_THRESHOLD = 8;
    public static final int ITEM_PICKUP_FEATHER_THRESHOLD = 6;
    public static final int ITEM_PICKUP_RAW_CHICKEN_THRESHOLD = 4;
    public static final int ITEM_PICKUP_THRESHOLD_LIMIT = 1024;
    public static final double ITEM_PICKUP_DETECTION_RADIUS = 8.0D;
    public static final double MAX_ITEM_PICKUP_DETECTION_RADIUS = 32.0D;
    public static final double ITEM_PICKUP_TIME_WINDOW_SECONDS = 12.0D;
    public static final double ITEM_PICKUP_AGGRESSION_DURATION_SECONDS = 10.0D;
    public static final double ITEM_PICKUP_MAX_ITEM_AGE_SECONDS = 120.0D;
    public static final boolean ITEM_PICKUP_NIGHT_MODIFIER_ENABLED = true;
    public static final double ITEM_PICKUP_NIGHT_THRESHOLD_MULTIPLIER = 0.75D;
    public static final double MIN_ITEM_PICKUP_NIGHT_THRESHOLD_MULTIPLIER = 0.1D;
    public static final double MAX_ITEM_PICKUP_NIGHT_THRESHOLD_MULTIPLIER = 4.0D;
    public static final boolean ITEM_PICKUP_SOCIAL_PROPAGATION_ENABLED = true;
